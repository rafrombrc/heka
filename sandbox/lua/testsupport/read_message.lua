...
function process_message ()
    ...
    if read_message("Payload") ~= "Payload Test" then return 3 end
    ...
    if read_message("Fields[empty_bytes]") ~= "" then return 20 end
    if read_message("Fields[not_there]") ~= nil then return 21 end
    return 0
end
